...
Following is the table list of Sandbox resource capacity and Quota limits:
   ...
   | ------- | --------- | ---- | ---- |
   | Virtual Server for VPC | vCPU: 128 RAM:1028GB |  |
   | Bare Metal Servers for VPC | 1 Baremetal provisioning |  |
   | Block Storage for VPC | Allowed is 4096GB of data volume per VSI |  |
   | Instance Storage for VPC | 1024 GB of Instance storage | |
